    ...
    API.get('/users', {
      ...
      (result) => {
        this.setState({
          ...
          currentPageNumber: result.data._meta.currentPage,
          numItemsPerPage: result.data._meta.perPage,
          totalItems: result.data._meta.totalCount,
            ...
            <table className='table'>
              <thead>
                <tr>
                  ...
                  <th>Avatar</th>
                  <th>
                    <a onClick={() => this.sortBy('first_name')}>First Name</a>
                  </th>
                  <th>
                    <a onClick={() => this.sortBy('last_name')}>Last Name</a>
                  </th>
                  <th>
                    <a onClick={() => this.sortBy('gender')}>Gender</a>
                  </th>
                  <th>
                    <a onClick={() => this.sortBy('dob')}>Dob</a>
                  </th>
                  <th>Phone</th>
                  <th>Email</th>
                  <th>Website</th>
                  <th>
                    <a onClick={() => this.sortBy('status')}>Status</a>
                  </th>
                  <th>Actions</th>
                </tr>
              </thead>
